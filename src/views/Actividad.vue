  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Visualizando datos
        p.mb-4 Identificar especificaciones técnicas logrando la identificación relacionada con las herramientas de visualización de datos con Python.
